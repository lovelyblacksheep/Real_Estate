export const InputForm = [
  { name: "propertyStatus", label: "Property Status", size: "12", options: ["Property Status", "For Rent", "For Sale", "Lands"] },
...
export const createPropertyInputForms = [
  ...
  { name: "propertyStatus", label: "Property Status", size: "12", options: ["Property Status", "For Rent", "For Sale", "Lands"], validation: { required: true } },
